...
from torch_geometric.nn import SAGEConv, GraphConv, ResGatedGraphConv, TransformerConv, AGNNConv, TAGConv, GINConv, GINEConv, ARMAConv, SGConv, DNAConv, SignedConv, GCN2Conv, GENConv, ClusterGCNConv, SuperGATConv, EGConv, GeneralConv, FiLMConv, WLConvContinuous
...
class SAGE_NeighSampler(torch.nn.Module):
    ...
    def forward(self, x, adjs):
        for i, (edge_index, _, size) in enumerate(adjs):
            x_target = x[:size[1]]
            # print('xxxxxxxxxxx',x.size(), edge_index.size())
