"""
Arthur: @DGraphXinye
Source Code: https://github.com/DGraphXinye/DGraphFin_baseline/blob/master/utils/dgraphfin.py
"""
...
from testlib import InMemoryDataset
...
def read_dgraphfin(folder):
    ...
    # print('item length', len(names), [name for name in names])
    
    x = items[0]['x']
    y = items[0]['y'].reshape(-1,1)
    edge_index = items[0]['edge_index']
    # print('ori.edge_index', edge_index)
